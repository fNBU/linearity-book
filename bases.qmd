...
Is the list $[(1,0),(0,1)] \subset \mathbb R^2$ linearly independent? Explain why.

:::

::: {#exr-linearly-indep-2}

Is the list $[(2,1),(2,-1)] \subset \mathbb R^2$ linearly independent? Explain why.

:::

::: {#exr-linearly-indep-3}

Is the list $[(1,2),(3,4),(-1,4)] \subset \mathbb R^2$ linearly independent? Explain why.
...
we say that $B$ is *a basis for* $V$.
...
## How do objects change when we change basis?

::: {#exr-basis-change-1}
> Suppose we have fixed a basis for $\mathbb R^3$.
> Let $A : \mathbb R^3 \to \mathbb R^3$ be given by the matrix
> $$
> \begin{bmatrix}
> 2 & -1 & 0 \\
> 3 & -3 & 1 \\
...
> \end{bmatrix}
> $$
> and let the vector $v$ be given by
> $$
> \begin{bmatrix}
> -2 \\
> 3 \\
...
> Compute $Av$.
> 
> Consider the basis (call it $\tilde{B}$)
> $$
> \left[
> \begin{bmatrix}
> 1 \\
...
> $$
> 
> Write $A$ and $V$ relative to $\tilde{B}$.
> 
> Call the new matrix and vector $\tilde{A}$ and $\tilde{v}$.
> Compute $\tilde{A}\tilde{v}$.
> 
> Convert your answer for $\tilde{A}\tilde{v}$ back to the standard basis.
> Did you get the same thing as $Av$?
:::