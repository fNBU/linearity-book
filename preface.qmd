...
1. 
    ...
    It is also a very mathematician's way of thiking to begin with a definition of a set of objects which will be mapped into or out of (viz. most treatments of Abstract Algebra).
